    ...
    return (
        <nav className={NavBarStyles["nav-bar--container"]}>
            <ul className={NavBarStyles["nav-bar"]}>
                ...
                <li className={`${NavBarStyles["nav-bar__link"]} ${NavBarStyles["nav-bar__link--linkedin"]}`}><a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/daan-warming">LinkedIn</a></li>
